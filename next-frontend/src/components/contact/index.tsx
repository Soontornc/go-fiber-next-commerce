...
const Contact = () => {
  return (
    <>
      <Breadcrumb title={"ติดต่อเรา"} pages={["ติดต่อเรา"]} />
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="flex gap-4">
                    ...
                    ที่อยู่: เลขที่ 5 ซอยลาดพร้าววังหิน 68 ถนนลาดพร้าววังหิน แขวงลาดพร้าว เขตลาดพร้าว กรุงเทพมหานคร 10230
                  </p>
                </div>
              </div>
            </div>
